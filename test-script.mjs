...
console.log('Contains "Senior Software Engineer"?', result.includes('Senior Software Engineer'));
...
console.log('Still has {{ entry.company }}?', result.includes('{{ entry.company }}'));
